...
type
  ...
  published
    ...
    procedure TestSendingClienteMultitenancy;
  end;
...
procedure TTestClienteTestCase.TestSendingClienteMultitenancy;
var
  JSON: string;
  Cliente: IPanamahCliente;
begin
  ...
  begin
    ...
    Save(Cliente, '03992843467');
    Save(Cliente, '02541926375');
    Save(Cliente, '00934509022');
    Flush;
  end;
end;
