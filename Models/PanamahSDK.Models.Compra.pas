...
begin
  ...
  if not IsValueBetween(Compra.Valor, -999999999.99, 999999999.99) then
    Validations.AddFailure('Compra.Valor ultrapassou limite mínimo ou máximo permitido. (Min: -999999999.99, Max: 999999999.99)');
